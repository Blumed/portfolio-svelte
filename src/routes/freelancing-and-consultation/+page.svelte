...
<section class="clean-background">
	...
	<p>
		...
		performant informative websites and applications. Spent 6 years working at various agencies where time and performance matter.
		For the last 7 years I have been working at start up working and maintaining a large web app.
	</p>
</section>

<section class="decorative-background">
	<h2><strong>Let's build something together</strong></h2>
	<p>Over the years I have worked on a wide breath of projects and technologies. I have created full Javascript banner ads to ecommerce sites.</p>
		<Tabs>
	<TabList>
	...
	<TabPanel>
		<ul>
			<li>Site Audit ( Performance, SEO, )</li>
			<li>SEO Strategy</li>
