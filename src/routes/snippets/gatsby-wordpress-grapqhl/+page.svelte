...
<div class="container">
	...
	<hr />
	<h2 id="check-wordpress-data">Check data data coming from Wordpress</h2>
	<p>
	...
	<Prism language="graphql" code={selfLink} />
	<button type="button" class="button" on:click={() => navigator.clipboard.writeText(selfLink)}
		>Copy Script</button
	>
	<h2>Find large assets in your Wordpress media library</h2>
	<p>
	...
	<Prism language="graphql" code={largeAssets} />
	<button type="button" class="button" on:click={() => navigator.clipboard.writeText(largeAssets)}
		>Copy Script</button
	>
	<h2>Investigate template pages</h2>
	<p>
	...
	<Prism language="graphql" code={templateUrls} />
	<button type="button" class="button" on:click={() => navigator.clipboard.writeText(templateUrls)}
		>Copy Script</button
	>
</div>
