...
<section>
    ...
    <form action="//formspree.io/cullan.luther@gmail.com" method="POST">
        <div class="clear">
            <div class="field">
                <input class="-m-break" type="text" id="frmName" placeholder="Jim Gime" name="name" required autocomplete="name" focus>
                <label for="frmName">Full Name</label>
            </div>
            <div class="field">
                <input class="-m-break" type="email" id="frmEmail" placeholder="jim.gime@email.com" name="_replyto" required autocomplete="email">
                <label for="frmEmail">Email</label>
            </div>
            <input type="hidden" name="_subject" value="New Blog Submission!" />
            <div class="field">
                <textarea class="-m-break" type="text" placeholder="Enter Your Hiko's Here" name="message"></textarea>
